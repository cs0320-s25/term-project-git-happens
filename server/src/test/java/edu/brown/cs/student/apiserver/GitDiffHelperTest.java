...
public class GitDiffHelperTest {
  ...
  public void testDifferenceDetectedWithSameFiles() {
    ...
    Map<String, List<MockFileObject>> incoming =
        Map.of("file1", List.of(fileObj("a"), fileObj("b")));
  ...
  public void testAutoMergeIdenticalFiles() {
    ...
    List<MockFileObject> result =
        diffHelper.autoMergeIfPossible("file1", list, new ArrayList<>(list));
