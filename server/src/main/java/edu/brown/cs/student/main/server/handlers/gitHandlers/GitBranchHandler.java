  ...
  public Object handle(final Request request, final Response response) throws Exception {
    ...
    try {
      ...
      // TODO: if branchRequest == "-d" + ...:
        ...
        if (newBranch == null || currentFilemap == null) {
          returnErrorResponse("error_bad_request", "null parameter(s)", (newBranch==null? "new_branch_id" : "") + (currentFilemap==null? ", file_map_json" : ""));
        }
        storage.addBranch(sessionId, newBranch, currentFilemap);
        responseMap.put("session_id", sessionId);
