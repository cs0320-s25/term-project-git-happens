...
public class MockStorage implements StorageInterface {
  ...
  private final Map<String, Map<String, Map<String, List<Map<String, Object>>>>> localCommits =
      new HashMap<>();
  ...
  private final Map<String, Map<String, Map<String, List<Map<String, Object>>>>> stagedCommits =
      new HashMap<>();
  ...
  public void addSession(String sessionId, String userId, String fileMapJson) {
    ...
    Map<String, Object> initialCommit =
        Map.of("commit_id", "initial", "file_map_json", fileMapJson);
  ...
  public Map<String, Object> getLatestRemoteCommit(String sessionId, String branchId) {
    return (Map<String, Object>)
        remoteHeads.getOrDefault(sessionId, Map.of()).getOrDefault(branchId, Map.of());
  }

  @Override
  public Map<String, Object> getLatestLocalCommit(
      String sessionId, String userId, String branchId) {
    return (Map<String, Object>)
        localHeads
  ...
  public Map<String, Object> commitChange(
      String sessionId, String userId, String branchId, String message, List<String> parents) {
  ...
  public Map<String, Object> popStash(String sessionId, String userId, int index) {
    ...
    if (index < 0 || index >= stashList.size()) return null;
  ...
  public void addBranch(
      ...
      String newBranchId,
      String fileMapJson) {
    List<Map<String, Object>> currentCommits =
        localCommits.get(sessionId).get(userId).get(currentBranchId);
  ...
  public Map<String, List<Map<String, Object>>> getAllLocalCommits(
    ...
    result.put(
        "pushed_commits", new ArrayList<>(getLocalPushedCommits(sessionId, userId, branchId)));
  ...
  public Map<String, Object> getCommit(
      String sessionId, String userId, String branchId, String commitId) {
    for (Map<String, Object> commit :
        localCommits
            .getOrDefault(sessionId, Collections.emptyMap())
            .getOrDefault(userId, Collections.emptyMap())
            .getOrDefault(branchId, Collections.emptyList())) {
      if (commitId.equals(commit.get("commit_id"))) return commit;
    }
    return null;
  }
